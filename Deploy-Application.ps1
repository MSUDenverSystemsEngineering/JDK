...
Try {
    ...
    [string]$appName = 'Java Development Kit'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        $exitCode = Execute-MSI -Action 'Uninstall' -Path '{7B8A7BC9-611D-5E97-AE51-BB62567FFB9F}' -PassThru
        ...
        $exitCode = Execute-MSI -Path "$dirFiles/jdk-20_windows-x64_bin.msi" -Parameters "/qn" -PassThru
		If (($ExitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) {$mainExitCode = $exitCode.ExitCode}
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-MSI -Action Uninstall -Path '{7B8A7BC9-611D-5E97-AE51-BB62567FFB9F}' -PassThru -ContinueOnError $true
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAuwgqfB6Eawg9/
# EfOpoTdcS3E5p0BOQJK4AF7ksY4VjqCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgMCF80x/UyaF6
# kELSkg2o9xSWm0zeMQNYKO2kgVu5rvcwDQYJKoZIhvcNAQEBBQAEggGAjD27Nkpo
# 5MD9skd1ZIP2N+neToQs9yrtbvAFOcDgNYSkGphegEIDmWtIqLU2ZZ9LH7wlXzMT
# wd4W/anJRolAJOLAO+pIvYBGXGxv8mH8eiJEATily40xpBifURk+Z6i/XUdn1502
# BmaK8XDSSnm28GIpZ3Fb1rEtLN/4m4sPUh0bLS2lBU6EBIjhsUFzR3B5cnUa6qIb
# qs3keTI75U1wdsB2sVAiL5w/xAJrGOkiYkKoBBc/rrJZVG2SuUK2pUEWd3a1nofd
# 5ghZxhRkydVv4g01Vse0PTFz7y2gEDq0y41SoyQ9eKGYsPnX4GsdfldJlmPdg0lD
# FsiWuc6OYbxVskBjNjWzdzPz4HRWPrxK0/9k/q659/JKt4JA87IleTi2N0yxdhSa
# NfU8TZILkSd9JP3OqgSXh6b7482n9b+6Dx5281uIBdHS9yHNoJDTVP49HDEOF9Yo
# 2VPYU/cE6UfU09uJTXpYILyEA3ffe+SqBLoLP2FYaHoIJOZuNYdAgxfroYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzA1MDIy
# MDEyNTdaMD8GCSqGSIb3DQEJBDEyBDCgMqdxDEzVAwAmOFa9phyBJGkGkO6ep/XA
# /SK8qZKIJ2+fnhOMjqXHpZKaQTMs37YwDQYJKoZIhvcNAQEBBQAEggIATD50yGER
# SiuEYSzGEm/ueppnsWmKdO3v6N3mAWeT2MVIh4oprN1OlOMMvZUfZYXJ0GPOr+ig
# +j0bdhqHiB/yD+FIm/eGXklH6nb6t/a4P4e26lrHT4mTBv2BFxNMRt/XSPVA3kIc
# w8Ce4sXWbJtZ1xMvKOxYq5otAOvkZEnVaY+iVGtQff9LbdU0VToHG5NAbJjUk/V/
# DLe1luhb9Gkwrlrb0iP6y8dIsqauFLhAcvZn8LhKIGiM4Y64rkA93gvJJuhmVgkX
# nSxh8E+rjMwVC5oPQoMxJE7fqKKpNtnnUZ9DEd29c+o+Q55a5gJIRtZuxpBudBNQ
# 9iDhTceiY7Tv7oWKE2hthozNo7bN3Z7heUKsdHXb1Zwu3sExzyfLl7l+6pYCgpPd
# xW4ZX23/5lxEK8/UUAsgGCexk6gL/BO0gi8C0CYSV+Q9ZhIpS0Rl3anCMrlLMthI
# uHIjjycvsWGPuzAyrbDT91wFxdlC1DGhufwTlf4WgQbMKAHjbanoSa7V2kEfS38i
# wbvFWxG2RPjpXLdAleIAuIvylbGqaorkKFpMuXaCcyTgyrLBGxXkzGuf49nXT9gV
# V5JuyNd3+J37vH0FbVpRhCFtc+FwLY8bpgMO+aQopDG4r2M6KmDsjixokhFFnyHB
# /kuuTX8Yek6k+JdxEezta6Rn76dbTgpkL0c=
